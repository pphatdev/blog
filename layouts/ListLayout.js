    ...
    <div className='relative sm:pl-2.5'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5'>
        ...
        {displayPosts.map((frontMatter) => {
          ...
          return (
            <div key={slug} className="hover:bg-white/90 dark:bg-gray-800 bg-white/90 drop-shadow-md transition-all backdrop-blur-sm hover:drop-shadow-xl rounded-xl dark:hover:bg-slate-800 overflow-hidden">
              <Link href={`slug`}>
                <a>
                  <article className="flex flex-col gap-2 [&>span>span>img]:object-cover [&>span>span>img]:w-full">
                    <Image
                      className=""
                      src={thumbnail ?? ''}
                      width={`512`}
                    ...
                    <div className='px-4'>
                      ...
                      {/* <p className="text-sm line-clamp-3 text-slate-600">{summary}</p> */}
                    </div>
                  </article>
                </a>
              </Link>
              <div className='flex flex-wrap gap-2 my-2 px-4 pb-4'>
