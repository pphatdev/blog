            ...
            <div className="relative isolate px-6 my-5 lg:px-8">
                ...
                <div className="relative mx-auto max-w-7xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        ...
                        <div className="absolute right-1/3 -translate-y-8 -mb-px flex h-8 items-end overflow-hidden">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl font-black tracking-tight text-gray-900 dark:text-white sm:text-6xl"> Hello There !! <span className="text-transparent bg-clip-text bg-gradient-to-tr from-purple-600 to-primary-500"> Welcome to my blog</span>. </h1>
